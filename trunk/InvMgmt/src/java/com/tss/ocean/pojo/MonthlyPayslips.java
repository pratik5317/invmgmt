...
public class MonthlyPayslips implements java.io.Serializable {
    ...
    public MonthlyPayslips(Date salaryDate, Integer employeeId, Integer payrollCategoryId, Double amount, boolean isApproved, Integer approverId, boolean isRejected, Integer rejectorId, String reason, String remark) {
