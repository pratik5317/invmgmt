                ...
                <div class="col-md-9">
                    <div class="catagory-main-box top-radius">
                        ...
                        <div class="row text-pad-top visible-lg visible-md visible-sm">
                            <form:form action="add-purchase_order.html" method="POST" modelAttribute="purorder">                                
                                <div class="row tb-margin">
                                    ...
                                    <div class="div-center">
                                        <button type="submit" class="btn btn-orange" onclick="return submitDetailsForm();"><spring:message code="label.purorder.save" text="Default Text"/></button>
