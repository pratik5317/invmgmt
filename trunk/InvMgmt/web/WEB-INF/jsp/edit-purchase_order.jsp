            ...
            <div class="container">
                <div class="row container">
                    <div class="dashboard_main">
                        ...
                        <div class="page-title-text"><spring:message code="label.edit.purchaseorder" text="Default Text"/></div>
                    </div>
                </div>	
                <div class="row">
                <div class="col-md-3">
                ...
                <div class="col-md-9">
                    <div class="catagory-main-box top-radius">
                        ...
                        <div class="row text-pad-top visible-lg visible-md visible-sm">
                            <form:form action="edit-purchase_order.html" method="POST" modelAttribute="purorder">
                                <form:hidden path="id" />
                                <div class="row tb-margin">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-4 col-xs-12 control-label search-text"><spring:message code="label.purorder.purrequisition" text="Default Text"/></label>
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-4 col-xs-12 control-label search-text"><spring:message code="label.purorder.supplier" text="Default Text"/></label>
                                            <div class="col-sm-8 col-xs-12">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-4 col-xs-12 control-label search-text"><spring:message code="label.purorder.price" text="Default Text"/></label>
                                            <div class="col-sm-8 col-xs-12">                                            
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-4 col-xs-12 control-label search-text"><spring:message code="label.purorder.createdat" text="Default Text"/></label>
                                            <div class="col-sm-8 col-xs-12">                                            
                                    ...
                                    <div class="div-center">
                                        <button type="submit" class="btn btn-orange" onclick="return submitDetailsForm();"><spring:message code="label.purorder.update" text="Default Text"/></button>
