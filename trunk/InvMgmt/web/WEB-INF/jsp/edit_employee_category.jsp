                                ...
                                <div class="row tb-margin">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-4 col-xs-12 control-label search-text"><spring:message code="label.empcategory.category" text="Default Text"/></label><span style=" color : #f00;font-size : 1.1em;">*</span>
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-4 col-xs-12 control-label search-text"><spring:message code="label.empcategory.prefix" text="Default Text"/></label><span style=" color : #f00;font-size : 1.1em;">*</span>
                                            <div class="col-sm-8 col-xs-12">                                            
