            ...
            <div class="container">
                <div class="row container">
                    <div class="dashboard_main">
                        ...
                        <div class="page-title-text"><spring:message code="label.updatepayrollcategory" text="Default Text"/></div>
                </div>
            </div>	
            <div class="row">
                <div class="col-md-3">
                ...
                <spring:message code="label.payrollcategory.percentage.placeholder" var="percentageplaceholder" text="Default Text" />                               

                <div class="col-md-9">
                    <div class="catagory-main-box top-radius">
                        <div class="cat-box-title cat-title-font top-radius"><spring:message code="label.updatepayrollcategory" text="Default Text"/></div>
                        <div class="row text-pad-top visible-lg visible-md visible-sm">
                            <form:form action="edit_payroll_category.html" method="POST" modelAttribute="payrollcategory">
                                <form:hidden path="id" />
                                <div class="row tb-margin">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-4 col-xs-12 control-label search-text"><spring:message code="label.payrollcategory.percentage" text="Default Text"/></label>
                                            <div class="col-sm-8 col-xs-12">                                            
                                                <form:input type="text" class="form-control" path="percentage" placeholder="${percentageplaceholder}" />
