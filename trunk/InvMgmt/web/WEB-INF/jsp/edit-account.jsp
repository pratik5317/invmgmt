            ...
            <div class="container">
                <div class="row container">
                    <div class="dashboard_main">
                        ...
                        <div class="page-title-text"><spring:message code="label.updateaccount" text="Default Text"/></div>
                </div>
            </div>	
            <div class="row">
                <div class="col-md-3">
                ...
                <div class="col-md-9">
                    <div class="catagory-main-box top-radius">
                        <div class="cat-box-title cat-title-font top-radius"><spring:message code="label.updateaccount" text="Default Text"/></div>
                        <div class="row text-pad-top visible-lg visible-md visible-sm">
                            <form:form action="edit-account.html" method="POST" modelAttribute="account" enctype="multipart/form-data">
                                <form:hidden path="id" />
                                ...
                                <div class="div-center">
                                    <button type="submit" class="btn btn-orange" onclick="return submitDetailsForm();"><spring:message code="label.account.update" text="Default Text"/></button>
