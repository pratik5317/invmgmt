    ...
    <body role="document">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="catagory-main-box top-radius">
                        <div class="cat-box-title cat-title-font top-radius"><spring:message code="payrollcategories.list" text="Label value is missing !!!"/></div>
                            ...
                            <div class="tab-pane active" id="demo">
                                ...
                                <table id="dttable" class="table table-bordered table-striped" data-filter="#filter" data-page-size="5">
                                    <thead class="orange-bg border-t">
                                        <tr>
                                            <th data-toggle="true">
                                                <spring:message code="label.payrollcategory.category" text="Label value is missing !!!"/>
                                            </th>
                                            <th data-toggle="true">
                                                <spring:message code="label.payrollcategory.percentage" text="Label value is missing !!!"/>
                                            </th>
                                            <th data-toggle="true">
                                                <spring:message code="label.payrollcategory.percentageof" text="Label value is missing !!!"/>
                                            </th>
                                            <th data-toggle="true">
                                                <spring:message code="label.payrollcategory.isactive" text="Label value is missing !!!"/>
                                            </th>  
                                            <th data-toggle="true">
                                    ...
                                    <tbody>
                                        <c:forEach var="payrollcategory" items="${payrollCategoryList}">
                                            <tr>
                                                <td>${payrollcategory.name}</td>
                                                <td>${payrollcategory.percentage}</td>
                                                <td>${payrollCategorymap[payrollcategory.payrollCategoryId]}</td>
                                                <td>${payrollcategory.status}</td>
                                                <td>${payrollcategory.isDeduction}</td>
                                                <td>
                                                    <a href="edit_payroll_category.html?id=${payrollcategory.id}" class="btn btn-default btn-sm" type="button"><span class="glyphicon glyphicon-edit"></span>Edit</a>
                                                    <a href="delete_payroll_category.html?id=${payrollcategory.id}" class="btn btn-default btn-sm row-delete" type="button"><span class="glyphicon glyphicon-trash"></span> Delete</a>
                                                </td>
                                            </tr>                                        
                                        </c:forEach>
                                    </tbody>
