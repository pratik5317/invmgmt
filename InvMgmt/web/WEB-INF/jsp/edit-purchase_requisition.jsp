            ...
            <div class="container">
                <div class="row container">
                    <div class="dashboard_main">
                        ...
                        <div class="page-title-text"><spring:message code="label.updatepurrequisition" text="Default Text"/></div>
                </div>
            </div>	
            <div class="row">
                <div class="col-md-3">
                ...
                <div class="col-md-9">
                    <div class="catagory-main-box top-radius">
                        <div class="cat-box-title cat-title-font top-radius"><spring:message code="label.updatepurrequisition" text="Default Text"/></div>
                        <div class="row text-pad-top visible-lg visible-md visible-sm">
                            <form:form action="edit-purchase_requisition.html" method="POST" modelAttribute="purrequisition">
                                <form:hidden path="id" />
                                <div class="row tb-margin">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-4 col-xs-12 control-label search-text"><spring:message code="label.purrequisition.prno" text="Default Text"/></label>
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-4 col-xs-12 control-label search-text"><spring:message code="label.purrequisition.supplier" text="Default Text"/></label>
                                            <div class="col-sm-8 col-xs-12">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-4 col-xs-12 control-label search-text"><spring:message code="label.purrequisition.status" text="Default Text"/></label>
                                            <div class="col-sm-8 col-xs-12">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-4 col-xs-12 control-label search-text"><spring:message code="label.purrequisition.price" text="Default Text"/></label>
                                            <div class="col-sm-8 col-xs-12">                                            
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-4 col-xs-12 control-label search-text"><spring:message code="label.purrequisition.createdat" text="Default Text"/></label>
                                            <div class="col-sm-8 col-xs-12">                                            
                                    ...
                                    <div class="div-center">
                                        <button type="submit" class="btn btn-orange" onclick="return submitDetailsForm();"><spring:message code="label.purrequisition.update" text="Default Text"/></button>
                            ...
                            <form:form action="edit-purchase_requisition.html" method="POST" modelAttribute="purrequisition">
                                ...
                                <div class="row tb-margin">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <div class="form-group">                                            
                                            <div class="col-sm-8 col-xs-12">
                                                <spring:message code="label.purrequisition.isbilled" text="Default Text"/>
                                                <div class="form-control">
                                                    <form:radiobutton path="isbilled" value="true" /><spring:message code="label.purrequisition.status.yes" text="Default Text"/>
                                                    <form:radiobutton path="isbilled" value="false" /><spring:message code="label.purrequisition.status.no" text="Default Text"/>
                                                </div>
