    ...
    <head>
        ...
        <jsp:include page="headermenu.jsp"></jsp:include>
            <div class="container">
                ...
                <div class="col-md-9">
                    <div class="catagory-main-box top-radius">
                        <div class="cat-box-title cat-title-font top-radius"><spring:message code="label.payrollcategory" text="Default Text"/></div>
                        <div class="row text-pad-top visible-lg visible-md visible-sm">
                            <form:form action="add_payroll_category.html" method="POST" modelAttribute="payrollcategory">                                
