            ...
            <div class="container">
                <div class="row container">
                    <div class="dashboard_main">
                        ...
                        <div class="page-title-text"><spring:message code="label.add.leavetype" text="Default Text"/></div>
                </div>
            </div>	
            <div class="row">
                <div class="col-md-3">
                ...
                <div class="col-md-9">
                    <div class="catagory-main-box top-radius">
                        <div class="cat-box-title cat-title-font top-radius"><spring:message code="label.add.leavetype" text="Default Text"/></div>
                        <div class="row text-pad-top visible-lg visible-md visible-sm">
                            <form:form action="add_leave_type.html" method="POST" modelAttribute="leaveType">                                
                                <div class="row tb-margin">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-4 col-xs-12 control-label search-text"><spring:message code="label.leavetype.name" text="Default Text"/></label><span style=" color : #f00;font-size : 1.1em;">*</span>
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-4 col-xs-12 control-label search-text"><spring:message code="label.leavetype.code" text="Default Text"/></label><span style=" color : #f00;font-size : 1.1em;">*</span>
                                            <div class="col-sm-8 col-xs-12">                                            
