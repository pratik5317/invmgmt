        ...
        <div class="container">
            <div class="row container">
                <div class="dashboard_main">
                    ...
                    <div class="page-title-text"><spring:message code="leavetypes.list" text="Label value is missing !!!"/></div>
                </div>
            </div>	
                    <div class="row">
                        <div class="col-md-3">
                ...
                <div class="col-md-9">
                    <div class="catagory-main-box top-radius">
                        <div class="cat-box-title cat-title-font top-radius"><spring:message code="leavetypes.list" text="Label value is missing !!!"/></div>
...
<!--                                        <div class="form-group visible-xs">
                                ...
                                <table id="dttable" class="table table-bordered table-striped" data-filter="#filter" data-page-size="5">
                                    <thead class="orange-bg border-t">
                                        <tr>
                                            <th data-toggle="true">
                                                <spring:message code="label.leavetype.name" text="Label value is missing !!!"/>
                                            </th>
                                            <th data-hide="phone">
                                                <spring:message code="label.leavetype.code" text="Label value is missing !!!"/> 
                                            </th>
                                            <th data-hide="phone">
                                                <spring:message code="label.leavetype.status" text="Label value is missing !!!"/> 
                                            </th>
                                            <th data-hide="phone">
                                                <spring:message code="label.leavetype.maxleavecount" text="Label value is missing !!!"/> 
                                            </th> 
                                             <th data-hide="phone">
                                                <spring:message code="label.leavetype.carryforward" text="Label value is missing !!!"/> 
                                            </th> 
                                    ...
                                    <tbody>
                                        <c:forEach var="leaveTypes" items="${leaveTypesList}">
                                            <tr>
                                                <td>${leaveTypes.name}</td>
                                                <td>${leaveTypes.code}</td>
                                                <td>${leaveTypes.status}</td>
                                                <td>${leaveTypes.maxLeaveCount}</td>
                                                <td>${leaveTypes.carryForward}</td>
                                                <td>
                                                    <a href="edit_leave_type.html?id=${leaveTypes.id}" class="btn btn-default btn-sm" type="button"><span class="glyphicon glyphicon-edit"></span>Edit</a>
                                                    <a href="delete_leave_type.html?id=${leaveTypes.id}" class="btn btn-default btn-sm row-delete" type="button"><span class="glyphicon glyphicon-trash"></span> Delete</a>
                                                </td>
                                            </tr>                                        
                                        </c:forEach>
                                    </tbody>
