<%-- 
    Document   : payslip_list
    Created on : Sep 9, 2014, 11:22:39 PM
    Author     : sweta
--%>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="demo">
                                <div class="row tb-margin">
                                    <div class="col-sm-4">
                                        <a href="payslips.html" class="btn btn-info add-row addrow-btn-left"><spring:message code="employee.add" text="Label value is missing !!!"/></a>
                                    <form method="post" action="get_purorder_daterange.html">
                                            <table width="100%">
                                                <tr>
                                                    <td width="30%">Month: <input type="text" name="fromDate" id="fromDate" /></td> 
                                                    <td width="5%">&nbsp;</td> 
