        ...
        <div class="container">
            <div class="row container">
                <div class="dashboard_main">
                    ...
                    <div class="page-title-text">Add Purchase Requisition</div>
                </div>
            </div>	
            <div class="row">
                <div class="col-md-3">
                ...
                <div class="col-md-9">
                    <div class="catagory-main-box top-radius">
                        <div class="cat-box-title cat-title-font top-radius">Add Purchase Requisition</div>
                        ...
                        <div class="row tb-margin">
                            ...
                            <div class="col-sm-8 visible-lg visible-md visible-sm">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-4 col-xs-12 control-label search-text">Status:</label>
                                    <div class="col-sm-8 col-xs-12">
                                        <input id="filter" class="form-control" type="text"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-4 col-xs-12 control-label search-text">Approved by</label>
                                    <div class="col-sm-8 col-xs-12">
                                        <input id="filter" class="form-control" type="text"/>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-8 visible-xs">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-8 col-xs-12">
                                        <input id="filter" class="form-control" type="text" placeholder="Approved by:" />
                                    </div>
                                </div>
                            </div>
